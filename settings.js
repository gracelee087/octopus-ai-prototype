...
const renderBeforeSettings=render;render=function(){if(onboarding.ready&&view==='settings'){if(onboarding.role!=='manager'){view='personal';history.replaceState(null,'','#personal');renderBeforeSettings();return}
...
if(!onboarding.ready||onboarding.role!=='manager')return;
